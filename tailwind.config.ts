  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 8px hsl(24 95% 53% / 0.4)" }, "50%": { boxShadow: "0 0 24px hsl(24 95% 53% / 0.7)" } },
      },
      animation: {
